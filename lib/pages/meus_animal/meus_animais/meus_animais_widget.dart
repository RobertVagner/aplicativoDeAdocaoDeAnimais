...
import 'meus_animais_model.dart';
export 'meus_animais_model.dart';

class MeusAnimaisWidget extends StatefulWidget {
  const MeusAnimaisWidget({super.key});

  @override
  State<MeusAnimaisWidget> createState() => _MeusAnimaisWidgetState();
}

class _MeusAnimaisWidgetState extends State<MeusAnimaisWidget> {
  late MeusAnimaisModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => MeusAnimaisModel());
  ...
  Widget build(BuildContext context) {
    return FutureBuilder<List<AnimalRow>>(
      ...
      builder: (context, snapshot) {
        ...
        List<AnimalRow> meusAnimaisAnimalRowList = snapshot.data!;
        ...
        return GestureDetector(
          ...
          child: Scaffold(
            ...
            floatingActionButton: FloatingActionButton(
              onPressed: () async {
                context.pushNamed('AnimalCadastro');
              },
            ...
            body: SafeArea(
              ...
              child: Builder(
                builder: (context) {
                  final animais = meusAnimaisAnimalRowList.toList();
