...
import 'cadastro_post_model.dart';
export 'cadastro_post_model.dart';

class CadastroPostWidget extends StatefulWidget {
  const CadastroPostWidget({super.key});

  @override
  State<CadastroPostWidget> createState() => _CadastroPostWidgetState();
}

class _CadastroPostWidgetState extends State<CadastroPostWidget> {
  late CadastroPostModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CadastroPostModel());
                      ...
                      child: Column(
                        ...
                        children: [
                                ...
                                return SingleChildScrollView(
                                  ...
                                  child: Row(
                                    ...
                                    children: List.generate(itenss.length,
                                        (itenssIndex) {
                                      final itenssItem = itenss[itenssIndex];
                                      return Expanded(
                                        child: Stack(
                                          alignment:
                          ...
                          Align(
                            ...
                            child: Padding(
                              ...
                              child: Container(
                                ...
                                child: TextFormField(
                                  controller:
                                      _model.descricaoTextFieldTextController,
                                  focusNode: _model.descricaoTextFieldFocusNode,
                                  autofocus: false,
                                  obscureText: false,
                          ...
                          Align(
                            ...
                            child: Padding(
                              ...
                              child: Container(
                                ...
                                child: TextFormField(
                                  controller:
                                      _model.nomeAnimalTextFieldTextController,
                                  focusNode:
                          ...
                          Column(
                            mainAxisSize: MainAxisSize.max,
                            children: [
                              if (_model.cidadeTextFieldTextController.text !=
                                      null &&
                                  _model.cidadeTextFieldTextController.text !=
                                      '')
                                      ...
                                      child: Padding(
                                        ...
                                        child: Container(
                                          ...
                                          child: TextFormField(
                                            ...
                                            focusNode:
                                                _model.cidadeTextFieldFocusNode,
                                            autofocus: false,
                                            obscureText: false,
                                            decoration: InputDecoration(
                                              isDense: false,
                              ...
                              if (_model.dropDownEstadoValue != null &&
                                ...
                                Padding(
                                  padding: EdgeInsetsDirectional.fromSTEB(
                                      16.0, 0.0, 16.0, 0.0),
                                  child:
                                      FutureBuilder<List<VwCidadesEstadosRow>>(
                                    future:
                                        (_model.requestCompleter ??= Completer<
                                                List<VwCidadesEstadosRow>>()
                                              ..complete(VwCidadesEstadosTable()
                                                  .queryRows(
                                                queryFn: (q) => q
                                                    .eq(
                                                      'cidade_name',
                                ...
                                onPressed: () async {
                                  {
                                    ...
                                    try {
                                      ...
                                      selectedMedia =
                                        ...
                                        storageFolderPath: '/postagens_publi',
                                        isMultiData: true,
                                      );
                                      downloadUrls =
                                  ...
                                  await PostagemTable().insert({
                                    ...
                                    'texto': _model
                                        .descricaoTextFieldTextController.text,
                                    'id_usuario': currentUserUid,
                                    'postagem_perdidos': false,
                                    'estado': _model.dropDownEstadoValue,
                                    'nomeAnimal': _model
                                        .nomeAnimalTextFieldTextController.text,
                                    'cidade': functions.recebeCidade(_model
                                        .cidadeTextFieldTextController.text),
                                  });
                                  context.safePop();
                                },
                                text: 'Publicar',
