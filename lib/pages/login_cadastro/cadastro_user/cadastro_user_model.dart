...
import 'cadastro_user_widget.dart' show CadastroUserWidget;
import 'dart:async';
...
class CadastroUserModel extends FlutterFlowModel<CadastroUserWidget> {
  ...
  // State field(s) for atendimento_TextField widget.
  FocusNode? atendimentoTextFieldFocusNode;
  TextEditingController? atendimentoTextFieldTextController;
  String? Function(BuildContext, String?)?
  ...
  void dispose() {
    ...
    atendimentoTextFieldFocusNode?.dispose();
    atendimentoTextFieldTextController?.dispose();
  }
